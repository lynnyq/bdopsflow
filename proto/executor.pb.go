...
const file_executor_proto_rawDesc = "" +
	"\n" +
	"\x0eexecutor.proto\x12\tbdopsflow\"[\n" +
	"\x0fRegisterRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddress\x12\x1a\n" +
	"\bcapacity\x18\x03 \x01(\x05R\bcapacity\"k\n" +
	"\x10RegisterResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12#\n" +
	"\rexecutor_name\x18\x03 \x01(\tR\fexecutorName\"\x8e\x01\n" +
	"\x10HeartbeatRequest\x12#\n" +
	"\rexecutor_name\x18\x01 \x01(\tR\fexecutorName\x12!\n" +
	"\fcurrent_load\x18\x02 \x01(\x05R\vcurrentLoad\x122\n" +
	"\x15running_execution_ids\x18\x03 \x03(\tR\x13runningExecutionIds\"p\n" +
	"\x11HeartbeatResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12'\n" +
	"\x0ftarget_capacity\x18\x03 \x01(\x05R\x0etargetCapacity\";\n" +
